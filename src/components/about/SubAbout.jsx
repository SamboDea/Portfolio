      ...
      <Container data-aos="zoom-in">
        <div className="row align-items-center modern-about-section">
          ...
          <div className="col-12 col-lg-7 text-white">
            <h3 className="fw-bold mb-3 name text-white">
              Hello! I'm Dea Sambo
            </h3>
            ...
            <div className="modern-card p-1 mb-3">
              <h5 className="fw-semibold mb-2 text-white">My Journey</h5>
